...
API_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjI0ZjIwMDY5NjlAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.AajAR7XI1eIWtEGSbRPpPEt5_zQ6vUaD54LVE9SZDe4"
# Models
            ...
            try:
                ...
                if similarity >= SIMILARITY_THRESHOLD:
                    ...
                    if not url.startswith("http"):
                        ...
                        url = f"http://discourse.onlinedegree.iitm.ac.in/t/{url}"
            ...
            try:
                ...
                if similarity >= SIMILARITY_THRESHOLD:
                    ...
                    if not url or not url.startswith("http"):
                        ...
                        url = f"http://docs.onlinedegree.iitm.ac.in/{chunk['doc_title']}"
